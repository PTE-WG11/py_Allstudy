import requests
import json
# https://blog.csdn.net/huo_1214/article/details/79233511?utm_source=app&app_version=5.3.1&code=app_1562916241&uLinkId=usr1mkqgl919blen
...
while 1:
    ...
    if city == '0':
        ...
        url = 'http://api.map.baidu.com/telematics/v3/travel_city?location=%s&ak=XST7XPvm4MfGQsB70o1uFHAAs7y0QKv2&output=json' % city
        rs = requests.get(url)
        print(rs.text)
